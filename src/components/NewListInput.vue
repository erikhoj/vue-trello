<template>
  <div class="new-list-input">
    ...
    <div class="adding-list-parent" v-if="isAddingList">
      <input name="name" class="list-name-input" placeholder="Enter list title..." maxlength="512" />
    </div>
  </div>
</template>
...
import { START_ADDING_LIST, SET_NEW_LIST_NAME, CANCEL_ADDING_LIST } from '../store/mutation-types';
